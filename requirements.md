...
* **Mac**
  ...
  * Install [Python **3.7** (3.8 is not supported)](https://www.python.org/ftp/python/3.7.5/python-3.7.5-macosx10.6.pkg)
...
* **Ubuntu/Debian based Linux**:
  ...
  * Install Python **3.7** `sudo apt-get install python3`
