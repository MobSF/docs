...
Establezca la variable de entorno `MOBSF_ANALYZER_IDENTIFIER` como identificador de dispositivo de AVD cuando ejecute la imagen acoplable de MobSF (Ejemplo: `emulator-5554`).
