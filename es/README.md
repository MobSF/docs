...
Mobile Security Framework (MobSF) es una aplicación móvil (Android/iOS/Windows) todo en uno y automatizada para pruebas de penetración (pen-testing), análisis de malware y asesoramiento de seguridad capáz de lograr un análisis dinámico y estático.
...
[![Donar a MobSF](https://user-images.githubusercontent.com/4301109/117404264-7aab5480-aebe-11eb-9cbd-da82d7346bb3.png)](https://opensecurity.in/donate)

Si encontraste MobSF útil, por favor considera donar al proyecto.

### Cursos y Certificaciónes de MobSF

Se cuentan con 2 cursos en inglés y en linea que cubren MobSF y otras herramientas para seguridad en Android.

![MobSF Curse](https://user-images.githubusercontent.com/4301109/76344880-ad68b580-62d8-11ea-8cde-9e3475fc92f6.png) [Automated Mobile Application Security Assessment with MobSF -MAS](https://opsecx.com/index.php/product/automated-mobile-application-security-assessment-with-mobsf/)
